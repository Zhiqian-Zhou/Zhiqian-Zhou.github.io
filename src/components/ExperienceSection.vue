...
<template>
  ...
  >
    ...
    <div class="relative border-l-2 border-slate-200 ml-4 space-y-14">
      <div
      ...
      >
        ...
        <p class="text-lg text-slate-700 mb-4 font-medium flex items-center gap-2">
        ...
        >
          <p class="text-slate-600 leading-relaxed" :class="{ 'mb-3': item.sub }" v-html="item.body"></p>
